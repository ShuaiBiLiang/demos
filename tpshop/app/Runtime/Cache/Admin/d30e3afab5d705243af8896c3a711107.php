    ...
    <div class="formbody">
        ...
        <form action="<?php echo U('add');?>" method="post" enctype="multipart/form-data">
            <ul class="forminfo">
                <li>
                    <label>商品名称</label>
                    <input name="title" placeholder="请输入商品名称" type="text" class="dfinput" /><i>名称不能超过30个字符</i></li>
                <li>
                    <label>商品价格</label>
                ...
                <li><label>是否上架</label><cite><input name="is_show" type="radio" value="1" checked="checked" />上架&nbsp;&nbsp;&nbsp;&nbsp;<input name="is_show" type="radio" value="0" />下架</cite></li>
            </ul>
            <ul class="forminfo">
                <li>
                    <label>商品描述</label>
                    <textarea name="goods_desc" id="goods_desc" placeholder="请输入商品描述" cols="" rows="" class="textinput textinput2"></textarea>
                </li>
            </ul>
