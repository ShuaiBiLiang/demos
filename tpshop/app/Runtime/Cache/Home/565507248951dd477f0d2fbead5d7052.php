...
<body>
	...
	<div class="fillin w990 bc mt15">
		...
		<div class="fillin_bd">
			...
			<div class="goods">
				...
				<table>
					...
					<tbody>
						<?php if(is_array($cart_info)): $i = 0; $__LIST__ = $cart_info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
							<td class="col1"><a href=""><img src="/Public/Uploads<?php echo ($vo["thumb"]); ?>" alt="" /></a>  <strong><a href=""><?php echo ($vo["goods_name"]); ?></a></strong></td>
							<td class="col3"><?php echo (sprintf("%.2f",$vo["goods_price"])); ?></td>
							<td class="col4"><?php echo ($vo["goods_buy_number"]); ?></td>
							<td class="col5"><span><?php echo (sprintf("%.2f",$vo["goods_total_price"])); ?></span></td>
					...
					<tfoot>
						<tr>
							<td colspan="5">
								<ul>
									<li>
										<span><?php echo ($vo["goods_buy_number"]); ?> 件商品，总商品金额：</span>
										<em>￥<?php echo ($getNumberPrice["price"]); ?></em>
									</li>
									<!-- <li>
										<span>返现：</span>
										<em>-￥240.00</em>
		...
		<div class="fillin_ft">
			<a href="<?php echo U('Cart/buy');?>"><span>提交订单</span></a>
			<p>应付总额：<strong>￥<?php echo ($getNumberPrice["price"]); ?>元</strong></p>
