		...
		<div class="list_bd fl ml10 mt10">
			...
			<div class="goodslist mt10">
				...
				<?php if(is_array($goods)): $i = 0; $__LIST__ = $goods;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
						<dl>
							<dt><a href="<?php echo U('Goods/detail',array('id'=>$vo['goods_id']));?>"><img src="/Public/Uploads<?php echo ($vo["goods_small_logo"]); ?>" alt="" /></a></dt>
							<dd><a href="<?php echo U('Goods/detail',array('id'=>$vo['goods_id']));?>"><?php echo ($vo["goods_name"]); ?></a></dt>
