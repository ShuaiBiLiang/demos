...
<body style="background-color:#1c77ac; background-image:url(/Public/Admin/images/light.png); background-repeat:no-repeat; background-position:center top; overflow:hidden;">
        ...
        <div class="loginbody">
            ...
            <div class="loginbox">
                <ul>
                    ...
                    <li>
                        <input name="verify" type="text" class="loginpwd verify" placeholder="密码" />
                        <img class="code" src="<?php echo U('Index/code');?>" alt="" onclick="this.src='<?php echo U('Index/code');?>?' + (new Date()-0)">
                    </li>
                    <li>
    ...
    <div class="loginbm">版权所有 &copy;2016 <a href="http://www.pingan.com/">中国平安 万事安康</a> </div>
</body>
